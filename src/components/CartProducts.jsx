...
export const CartProducts = ({cartCounter}) => {

    const cartValue = 125 * cartCounter;
    ...
    <div className="flex flex-col gap-6">
        ...
        {/* Checkout Button */}
        <button className="bg-orange py-4 rounded-xl text-white mb-2 font-bold">Checkout</button>
    </div>
    )
}
